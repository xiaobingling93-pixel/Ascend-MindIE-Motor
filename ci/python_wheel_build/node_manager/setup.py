...
setup(
    ...
    description="MindIE node manager service",
    packages=find_packages(where=_PKG_ROOT, include=("node_manager", "node_manager.*")),
    package_dir={"": _PKG_ROOT},
    python_requires=">=3.9",
    install_requires=_read_requirements(),
    entry_points={
        "console_scripts": ["node_manager=node_manager.node_manager_run:main"]
    },
)
