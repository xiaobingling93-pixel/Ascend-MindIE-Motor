...
SERVER_DIR="$MINDIE_SERVICE_SRC_DIR"/mindie_service/server
MS_DIR="$MINDIE_SERVICE_SRC_DIR"/mindie_service/management_service
LLM_BACKEND_DIR="$MINDIE_SERVICE_SRC_DIR"/MindIE_Backends/MindIE_LLM_Backend
HTTP_CLIENT_CTL_DIR="$MINDIE_SERVICE_SRC_DIR"/mindie_service/utils/http_client_ctl
