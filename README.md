...
[2025/12] MindIE Motor正式宣布开源并面向公众开放！[会议日历](https://meeting.ascend.osinfra.cn/?sig=sig-MindIE-Motor)
...
通过软件包或镜像方式安装MindIE Motor，请参见[安装指南](./docs/zh/user_guide/install/installing_mindie.md)。
通过拉取最新代码编译安装MindIE Motor，请参见[编译安装指南](./docs/zh/developer_guide/build_guide.md)。
